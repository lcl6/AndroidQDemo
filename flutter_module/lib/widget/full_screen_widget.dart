...
import 'package:flutter_module/util/entity_state.dart';
...
class FullScreenWidget extends StatefulWidget {
  ...
  FullScreenWidget({required this.url, required this.videoPageEnum,required this.videoPlayerValue });

  @override
  _FullScreenWidgetState createState() => _FullScreenWidgetState(videoPlayerValue: videoPlayerValue);
}
...
class _FullScreenWidgetState extends State<FullScreenWidget> {
  ...
  VideoPlayerValue videoPlayerValue;
  _FullScreenWidgetState({required this.videoPlayerValue});
  ...
  void initState() {
    ...
    _controller = widget.videoPageEnum == VideoPageEnum.asset
      ...
      ..initialize().then((_) {
        ...
        // print('url=---position --${videoPlayerValue.position}');
        _controller.seekTo(videoPlayerValue.position);
        _controller.value=videoPlayerValue;
        // print('url=---_controller --${_controller.value.position}');
        // Ensure the first frame is shown after the video is initialized, even before the play button has been pressed.
        setState(() {});
      });

    _controller.addListener(() {
      print('url--当前进度--${_controller.value.position}');
      //当前进度  == 总进度
