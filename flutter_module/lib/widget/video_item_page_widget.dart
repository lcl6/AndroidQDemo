...
import 'package:flutter_module/widget/full_screen_widget.dart';
...
class _VideoItemPageWidgetState extends State<VideoItemPageWidget>
  ...
  void initState() {
    ...
    print('url initState=----${widget.url}');
  ...
  Widget initFullScreen() {
    return GestureDetector(
      ...
      onTap: () {
        ...
        print('url=----${widget.url}--value --${_controller.value}');
        NavigatorUtil.pushPage(
            context: context,
            widget:
                FullScreenWidget(url: widget.url, videoPageEnum: widget.type,videoPlayerValue:_controller.value), dismissCallBack: (value) {  });
      },
    );
  }
}
